...
HD_PWD='D:/DERS/ee102/Term Project/Final Phase/digital_term_project/digital_term_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log servo_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source servo_control.tcl
